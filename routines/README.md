...
4. **Read routine prompts through the guarded reader.** Do not `sed`/`cat`
   ...
   a bounded noop/backoff, not a routine error or product blocker. If the
   install is dirty, diverged, or the helper is missing, it prints
