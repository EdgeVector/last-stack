...
make_plist broken "/Users/REPLACE/.local/bin:/opt/homebrew/bin:/usr/local/bin:/usr/bin:/bin"
# Already correct — must be left untouched and reported OK, not FIXED.
make_plist clean "/Users/REPLACE/.local/bin:/usr/bin:/opt/homebrew/bin:/usr/local/bin:/bin"
...
test "$unchanged" = "/Users/REPLACE/.local/bin:/opt/homebrew/bin:/usr/local/bin:/usr/bin:/bin"
...
test "$fixed" = "/Users/REPLACE/.local/bin:/usr/bin:/opt/homebrew/bin:/usr/local/bin:/bin"

clean_untouched="$(/usr/libexec/PlistBuddy -c 'Print :EnvironmentVariables:PATH' "$tmp/com.edgevector.clean.plist")"
test "$clean_untouched" = "/Users/REPLACE/.local/bin:/usr/bin:/opt/homebrew/bin:/usr/local/bin:/bin"
