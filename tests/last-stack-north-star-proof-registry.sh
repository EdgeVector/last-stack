...
for required in north-star-revenant-watch north-star-app-ops-latency north-star-lastdb-canary-pipeline-v2 north-star-lastdb-ideal-storage-shape north-star-lastdb-uuid-hash-group-addressing north-star-lastdb-cloud-owned-gc; do
