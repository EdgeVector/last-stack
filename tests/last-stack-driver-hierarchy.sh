...
require "['list', '--column', 'backlog']" "$milestone_snapshot"
require "['list', '--column', 'todo']" "$milestone_snapshot"
require "['list', '--column', 'doing']" "$milestone_snapshot"
require "['milestone', 'portfolio']" "$milestone_snapshot"
...
require "refuse('stale-or-invalid-artifact')" "$milestone_snapshot"
require 'proof-waiver-refused' "$milestone_snapshot"
require "['milestone', 'detail', slug]" "$milestone_snapshot"
require 'dependency-unsatisfied' "$milestone_snapshot"
require 'dependency-proof-disagrees' "$milestone_snapshot"
require 'completion-proof-not-current' "$milestone_snapshot"
...
require 'Use the report as a candidate queue' "$milestone"
require 'Do not infer acceptance completion from child counts.' "$milestone"
