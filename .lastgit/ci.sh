...
ci_test tests/last-stack-pipeline-pr-guard.sh
...
ci_test tests/last-stack-safe-upgrade-rollback-recipe-is-atomic.sh
...
ci_test tests/last-stack-forge-merge-green.sh
